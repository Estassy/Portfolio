  ...
  return (
    <footer className="border-t border-neutral-900 py-4">
      <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 text-sm text-neutral-500 md:flex-row md:items-center md:justify-between">
        <p className="select-none">© {new Date().getFullYear()} <span className="bg-gradient-to-r from-neutral-200 to-neutral-400 bg-clip-text text-transparent">Marc Estassy BATABA</span> — Tous droits réservés.</p>
